                                            ...
                                            <div style="padding: 0" class="modal-body">
                                                <div class="card">
                                                    <form class="form theme-form" method="post"
                                                          action="{{ url('dashboard/instagram/store') }}"
                                ...
                                @foreach($instagrams as $index=>$instagram)
                                    <tr>
                                        ...
                                        <td><img
                                                ...
                                                src="{{ url("uploads/$instagram->img") }}"></td>
                                        <td>{{ $instagram->link }}</td>
                                        <td>{{ \Carbon\Carbon::parse($instagram->created_at)->format('d M, Y') }}</td>
                                        <td>
                                            <a href="{{ url("dashboard/instagram/delete/$instagram->id") }}"
                                            ...
                                            <button class="btn btn-primary btn-xs" type="button" data-bs-toggle="modal"
                                                    data-bs-target=".bd-example-modal-xxl{{$instagram->id}}">Edit
                                            </button>
                                            <div class="modal fade bd-example-modal-xxl{{$instagram->id}}" tabindex="-1" role="dialog"
                                                 aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div style="padding: 0" class="modal-body">
                                                            <div class="card">
                                                                <form class="form theme-form" method="post"
                                                                      action="{{ url("dashboard/instagram/update/$instagram->id") }}"
