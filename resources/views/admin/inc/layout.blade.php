                ...
                <nav class="sidebar-main">
                    ...
                    <div id="sidebar-menu">
                        <ul class="sidebar-links" id="simple-bar">
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{ url('/dashboard/blog') }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{ url('/dashboard/feedback') }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{ url('/dashboard/contact') }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{ url('/dashboard/gallery') }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{ url('/dashboard/instagram') }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{ url('/dashboard/menucats') }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                                    ...
                                    <span>Menu Categories</span></a>
                            </li>
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{ url('/dashboard/menu') }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{ url('/dashboard/partner') }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{ url('/dashboard/setting') }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{ url('/dashboard/stunning') }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                                    ...
                                    <span>Stunning Things</span></a>
                            </li>
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{ url('/dashboard/team') }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{ url('/dashboard/special') }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
...
<script src="{{ asset('admin/assets/js/editor/simple-mde/simplemde.min.js')}}"></script>
<script src="{{ asset('admin/assets/js/editor/simple-mde/simplemde.custom.js')}}"></script>
