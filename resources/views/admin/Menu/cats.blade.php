                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"> Menu Categories</li>
                        </ol>
                    </div>
                </div>
            </div>
                                            ...
                                            <div style="padding: 0" class="modal-body">
                                                <div class="card">
                                                    <form class="form theme-form" method="post"
                                                          action="{{ url('dashboard/menucats/store') }}"
                                ...
                                @foreach($cats as $index=>$cat)
                                    <tr>
                                        ...
                                        <td><img
                                                ...
                                                src="{{ url("uploads/$cat->icon") }}"></td>
                                        <td>{{ $cat->name('en') }}</td>
                                        <td>{{ $cat->name('ar') }}</td>
                                        <td>{{ \Carbon\Carbon::parse($cat->created_at)->format('d M, Y') }}</td>
                                        <td>
                                            <a href="{{ url("dashboard/menucats/delete/$cat->id") }}"
                                            ...
                                            <button class="btn btn-primary btn-xs" type="button" data-bs-toggle="modal"
                                                    data-bs-target=".bd-example-modal-xxl{{$cat->id}}">Edit
                                            </button>
                                            <div class="modal fade bd-example-modal-xxl{{$cat->id}}" tabindex="-1" role="dialog"
                                                 aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div style="padding: 0" class="modal-body">
                                                            <div class="card">
                                                                <form class="form theme-form" method="post"
                                                                      action="{{ url("dashboard/menucats/update/$cat->id") }}"
